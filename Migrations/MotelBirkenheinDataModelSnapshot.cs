...
namespace Motel_birkenhein.Migrations
{
    ...
    partial class MotelBirkenheinDataModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Motel_birkenhein.Models.Bett", b =>
                {
                    ...
                    b.Property<Guid?>("XReservierungId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Motel_birkenhein.Models.Reservierung", b =>
                {
                    ...
                    b.Property<float?>("Muss_bezahlen")
                        .HasColumnType("real");
            ...
            modelBuilder.Entity("Motel_birkenhein.Models.Tarif", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Motel_birkenhein.Models.Bett", b =>
                {
                    b.HasOne("Motel_birkenhein.Models.Reservierung", "XReservierung")
                        .WithMany("Bett")
                        .HasForeignKey("XReservierungId")
            ...
            modelBuilder.Entity("Motel_birkenhein.Models.Tarif", b =>
                {
                    b.HasOne("Motel_birkenhein.Models.Hotel", "XHotel")
                        .WithMany("Tarif")
